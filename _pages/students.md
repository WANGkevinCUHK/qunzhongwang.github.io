...
- 2024: [Kaizhao Liu](https://drzfct.github.io/) (a fast bootstrapping method, a first author paper submitted to ICML, PKU-> ?), [Hounam Wong](https://openreview.net/profile?id=~Honam_Wong1) (HKUST->?, Kernel Learning), Ruihan Xu(SJTU->?, Sketching), Siyuan Tang (Fine-Tuning Language Model, USTC->?, co-supervised with [Minshuo Chen](https://minshuochen.github.io/))
