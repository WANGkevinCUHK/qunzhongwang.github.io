...
- 2024: Kaizhao Liu (a fast bootstrapping method, a first author paper submitted to ICML, PKU-> ?), Siyuan Tang (Fine-Tuning Language Moel, USTC->?, co-supervised with [Minshuo Chen](https://minshuochen.github.io/)), Youheng Zhu(HUST->?), Hounam Wong (HKUST->?, Kernel Learning), Ruihan Xu(SJTU->?, Sketching and Randomized Linear Algebra)
